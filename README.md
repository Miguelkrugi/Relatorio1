...
|---|---|---|---|
|1|Selecionar os icones de ">" e "<"| Navegar por entre as diversas telas dos timers (Pomodoro Timer, Desktime Timer, Ultradian Timer, Hardcore Timer e Flowtime Timer)|Funcional
|2|Clicar no botão de "Play"|Iniciar o timer (presente em qualquer tela de timer). Após o inicio da contagem, o botão de "Pause" torna-se não clicável, não sendo possivel pausar o timer. Ao clicar no botão de "Play", a ligação Wi-Fi do dispositivo deverá ser desativada e o modo silencioso deste deve ser ativado|Funcional
|3|Selecionar o botão de "Reset" (quando o tempo do timer terminar)|Reinicia o timer (somente quando o tempo deste terminar)| Funcional
...
Link: https://www.mediafire.com/file/wh0ix9wdujnies4/Prot%25C3%25B3tipoBusyBrain.zip/file

# VIDEO DE APRESENTAÇÃO (LINK PARA ASSISTIR):

https://screenrec.com/share/X518eaWBTA

## TIMESTAMPS DO VIDEO:

  -> 00:06 - 00:11 ------> TIMERS DA APP (POMODORO, DESKTIME, HARDCORE & FLOWTIME)
  
  -> 00:13 - 00:15 ------> MUSICA AMBIENTE (APRESENTAÇÃO DOS SONS DISPONIVEIS NA APP)
  
  -> 00:16 - 00:24 ------> BLOQUEIO DE WEBSITES (SELEÇÃO DE BLOQUEIO ATRAVÉS DE CHECKBOXES E "OCULTAÇÃO" DE ACESSO A WEBSITES BLOQUEADOS, ATRAVÉS DE UMA LISTA)  
  
  -> 00:25 - 00:27 ------> WI-FI DESLIGADO DURANTE SESSÕES DE TRABALHO (ATRAVÉS DE UM SWITCH | UTILIZAÇÃO DE SHARED PREFERENCES PARA 'STORAGE' DOS 'SWITCH STATE')
  
  -> 00:28 - 00:30 ------> MODO SILENCIOSO DURANTE SESSÕES DE TRABALHO ('SILENT RINGER MODE', SILENCIAMENTO DE NOTIFICAÇÕES, SILENCIAMENTO DE ALARMES E SILENCIAMENTO TOTAL (INCLUSIVE CHAMADAS TELEFÓNICAS))
  
  -> 00:30 - 00:32 ------> INFORMAÇÕES SOBRE A CONTA DO UTILIZADOR (username, email e ID). SISTEMA DE LOGOUT.
  
  -> 00:36 - 00:42 ------> FILTRAGEM DE TAREFAS POR PRIORIDADE (ATRAVÉS DE CHIP BUTTONS)
  
  -> 00:43 - 00:57 ------> CRIAÇÃO DE UMA TAREFA (INSERÇÃO DE DADOS)
  
  -> 01:01 - 01:03 ------> DEMONSTRAÇÃO DA LISTA DE TAREFAS (GERAL)
  
  -> 01:06 - 01:13 ------> ELIMINAÇÃO DE TAREFAS (INSERINDO O ID)
  
  -> 01:18 - 01:20 ------> CRIAÇÃO DE GRUPOS (NOME DO GRUPO, DESCRIÇÃO E ID DA TAREFA CORRESPONDENTE)
  
  -> 01:22 - 01:29 ------> DEMONSTRAÇÃO DA LISTA DE GRUPOS, CHAT DE GRUPO (A SER IMPLEMENTADO) E LISTA DE PARTICIPANTES (ADICIONAR E REMOVER PARTICIPANTES)
  
  -> 01:35 - 01:40 ------> DEMONSTRAÇÃO DO FUNCIONAMENTO DA LOCALIZAÇÃO ATUAL DO UTILIZADOR
  
  -> 01:40 - 01:43 ------> FILTRAGEM DE LOCAIS POR CATEGORIA (BAR, CAFÉ, RESTAURANTE, LIVRARIA, BIBLIOTECA E OUTROS PONTOS DE INTERESSE (EX. RUAS, PRAÇAS, ETC.))
  
  -> 01:45 - 01:49 ------> MARCAÇÃO DE LOCAIS FAVORITOS, PRESENÇAS EM LOCAIS E LISTA DE LOCAIS FAVORITOS, BEM COMO A EXIBIÇÃO DE INFORMAÇÕES RELATIVAS A UM LOCAL SELECIONADO NO MAPA (IMPLEMENTAÇÃO PARA O UPDATE DA APP)
  
  -> 01:50 - 01:55 ------> DEMONSTRAÇÃO DE ROTAS ENTRE A LOCALIZAÇÃO ATUAL DO UTILIZADOR E UM LOCAL SELECIONADO
